# 微前端框架横行的年头，我用 iframe 玩转了公司的微应用业务
...
> 以上其实已经具备了基本雏形，不过正式对外推广其实还太过捡漏，有点说不过去，还得升个级 \
...
- [源码参考](https://github.com/howieyi/learning-tools)

## 思路小结

> 本文偏向思路型，主要给大家分享一个公司业务常见的场景，如有不对的烦请指出; \
> 如有帮助的，铁子们帮忙给个赞~~~
